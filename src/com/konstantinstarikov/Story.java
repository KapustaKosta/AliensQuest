                ...
                new ReplicaWithAnswers(
                        ...
                        new Answer("Очевидно, опять российский ракеты",
                                new ReplicaWithAnswers("Вице-президент: Тогда пока мобилизуем войска?",
                                        new Answer("Мобилизуйте", new ReplicaWithoutAnswers("Хорошо, будет сделано", new EndReplica())),
                                        new Answer("Нет, зачем тратить бюджет страны попусту?", new ReplicaWithoutAnswers("Да, господин Президент", new EndReplica())))
                        ),
                        ...
                        new Answer("Что вы там опять курите? Какие неопознанные летающие объекты?!", new ReplicaWithoutAnswers("Извините, что побеспокоил вас, мистер Президент, больше этого не повторится", new EndReplica())
                        )
                )
        );
                ...
                new ReplicaWithoutAnswers(
                        ...
                        new ReplicaWithAnswers(
                                ...
                                new Answer(
                                        ...
                                        new ReplicaWithoutAnswers("Вице-президент: Будет сделано!", new EndReplica()),
                                        () -> warDialogue.play()
                                ),
                ...
                new ReplicaWithoutAnswers(
                        ...
                        new ReplicaWithAnswers("Вице-президент: Наши войска терпят поражение в Монтане, " +
                                ...
                                new Answer("Заключим мир",
                                        new ReplicaWithoutAnswers("*Соединённые штаты Америки заключили мир с инопланетянами*", new EndReplica()), () -> dialogueEatingPeople.play()),
                                new Answer("Продолжим сражаться, мобилизуем все войска, что у нас есть.",
                                        new EndReplica(),
                                        () ->
                                {
                                    if(new Random().nextBoolean()) win.play();
                                    else  defeat.play();
                                }
                                )
                        )
